...
var file_proto_v1api_report_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x72, 0x74, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x21, 0x2e, 0x76, 0x31, 0x61,
...
var file_proto_v1api_report_proto_goTypes = []interface{}{
	(*ReportCreateRequest)(nil),  // 0: v1api.report.ReportCreateRequest
	(*ReportCreateResponse)(nil), // 1: v1api.report.ReportCreateResponse
}
var file_proto_v1api_report_proto_depIdxs = []int32{
	0, // 0: v1api.report.apiReportService.ReportCreate:input_type -> v1api.report.ReportCreateRequest
	1, // 1: v1api.report.apiReportService.ReportCreate:output_type -> v1api.report.ReportCreateResponse
